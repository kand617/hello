...
<head>
    ...
    <script src="scripts/SwaggerPetstoreLib/Controllers/PetsController.js"></script>
...
The singleton instance of the ``` PetsController ``` class can be accessed via Dependency Injection.

```js
	app.controller("testController", function($scope, PetsController, Pet){
	});
```
...
```javascript
	...
	app.controller("testController", function($scope, PetsController, Pet){
		...
		var result = PetsController.listPets(limit);
...
```javascript
	...
	app.controller("testController", function($scope, PetsController){


		var result = PetsController.createPets();
        //Function call returns a promise
        result.then(function(success){
			//success case
			//getting context of response
...
```javascript
	...
	app.controller("testController", function($scope, PetsController, Pet){
		...
		var result = PetsController.getShowPetById(petId);
        //Function call returns a promise
        result.then(function(success){
			//success case
			//getting context of response
